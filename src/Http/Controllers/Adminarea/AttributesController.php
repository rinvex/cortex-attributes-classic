...
class AttributesController extends AuthorizedController
{
    ...
    protected function process(FormRequest $request, Attribute $attribute)
    {
        ...
        return intend([
            ...
            'with' => ['success' => trans('cortex/foundation::messages.resource_saved', ['resource' => trans('cortex/attributes::common.attribute'), 'identifier' => strip_tags($attribute->name)])],
        ]);
    }
    ...
    public function destroy(Attribute $attribute)
    {
        ...
        return intend([
            'url' => route('adminarea.attributes.index'),
            'with' => ['warning' => trans('cortex/foundation::messages.resource_deleted', ['resource' => trans('cortex/attributes::common.attribute'), 'identifier' => strip_tags($attribute->name)])],
        ]);
    }
}
