    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group{{ $errors->has($attribute->slug) ? ' has-error' : '' }}">
                {{ Form::label($attribute->slug, $attribute->name, ['class' => 'control-label']) }}
                {{ Form::number($attribute->slug, ! $entity->exists ? $attribute->default : null, ['class' => 'form-control', 'placeholder' => $attribute->name, 'required' => $attribute->is_required ? 'required' : false]) }}
