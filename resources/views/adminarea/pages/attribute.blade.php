...
@section('content')
    ...
    @includeWhen($attribute->exists, 'cortex/foundation::common.partials.modal', ['id' => 'delete-confirmation'])
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="nav-tabs-custom">
                @if($attribute->exists && $currentUser->can('delete', $attribute))
                    <div class="pull-right">
                        <a href="#" data-toggle="modal" data-target="#delete-confirmation"
                           ...
                           data-modal-body="{{ trans('cortex/foundation::messages.delete_confirmation_body', ['resource' => trans('cortex/attributes::common.attribute'), 'identifier' => strip_tags($attribute->name)]) }}"
